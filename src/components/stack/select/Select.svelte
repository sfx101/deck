...
<div class="p-4 pr-0 bg-white dark:bg-chillgray-825 dark-border rounded-lg flex flex-col justify-center">
    <div class="flex-shrink-0 card rounded-none">
        <div class="form-control items-center grid grid-cols-5">
            <label class="col-span-2 label p-0" for="">
                <span class="label-text text-xs text-csgray-400 dark:text-csgray-200">
                    {inputObject.label}
                </span>
            </label>
            <!-- on:change={onChange} -->
            ...
            <select
                ...
                bind:value={selected}
                class="
                col-span-3 border-none justify-self-end p-0 focus:ring-0 text-csgray-500 dark:bg-transparent dark:text-csgray-300 text-right focus:outline-none px-4 w-24 {errorClass}
                bg-inherit
                "
