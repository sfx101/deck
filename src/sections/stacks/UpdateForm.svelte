...
{#each Object.entries(formFields) as [key1, obj1]}
    {#if obj1.length > 0}
        <dl
            class="bg-csgray-50 dark:bg-chillgray-800 dark-border shadow-sm rounded-lg p-4 inline-flex flex-col w-full h-fit-content float-left gap-4 break-inside mb-6"
        >
